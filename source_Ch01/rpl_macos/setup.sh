#!/bin/bash
#
# Introducing MySQL InnoDB Cluster - Chapter 1 : Setup Replication (macOS)
#
...
DATADIR='/Volumes/Macintosh_Data/<user>/source/rpl_macos'
...
mysql -uroot -h 127.0.0.1 -e "source /Volumes/Macintosh_Data/<user>/source/rpl_macos/create_rpl_user.sql" --port=13001
echo "> Creating replication user on slave1 ..."
mysql -uroot -h 127.0.0.1 -e "source /Volumes/Macintosh_Data/<user>/source/rpl_macos/create_rpl_user.sql" --port=13002
echo "> Creating replication user on slave2 ..."
mysql -uroot -h 127.0.0.1 -e "source /Volumes/Macintosh_Data/<user>/source/rpl_macos/create_rpl_user.sql" --port=13003
echo "> Creating replication user on slave3 ..."
mysql -uroot -h 127.0.0.1 -e "source /Volumes/Macintosh_Data/<user>/source/rpl_macos/create_rpl_user.sql" --port=13004
echo
echo ====== Step 4 of 6: START RPL ======
echo "> Executing CHANGE MASTER on slave1 ..."
mysql -uroot -h 127.0.0.1 -e "source /Volumes/Macintosh_Data/<user>/source/rpl_macos/change_master.sql" --port=13002
echo "> Executing START SLAVE on slave1 ..."
mysql -uroot -h 127.0.0.1 -e "START SLAVE" --port=13002
mysql -uroot -h 127.0.0.1 -e "source /Volumes/Macintosh_Data/<user>/source/rpl_macos/change_master.sql" --port=13003
echo "> Executing START SLAVE on slave2 ..."
mysql -uroot -h 127.0.0.1 -e "START SLAVE" --port=13003
mysql -uroot -h 127.0.0.1 -e "source /Volumes/Macintosh_Data/<user>/source/rpl_macos/change_master.sql" --port=13004
...
mysql -uroot -h 127.0.0.1 -e "source /Volumes/Macintosh_Data/<user>/source/rpl_macos/check_rpl.sql" --port=13001
echo
echo ====== Step 6 of 6: CREATE SOME DATA ======
echo "> Creating data ..."
mysql -uroot -h 127.0.0.1 -e "source /Volumes/Macintosh_Data/<user>/source/rpl_macos/sample_data.sql" --port=13001
sleep 3
